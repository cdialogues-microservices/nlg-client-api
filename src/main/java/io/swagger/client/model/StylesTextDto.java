...
public class StylesTextDto   {
  @SerializedName("richContents")
  private List<RichContent> richContents = new ArrayList<RichContent>();

  public StylesTextDto richContents(List<RichContent> richContents) {
    this.richContents = richContents;
    return this;
  }

  public StylesTextDto addRichContentsItem(RichContent richContentsItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StylesTextDto stylesTextDto = (StylesTextDto) o;
    return Objects.equals(this.richContents, stylesTextDto.richContents);
  }

  @Override
  public int hashCode() {
    return Objects.hash(richContents);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StylesTextDto {\n");
